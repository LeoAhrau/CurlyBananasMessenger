...
abstract class MessageAppDatabase : RoomDatabase() {  //version = 1: Detta anger versionen av databasen, vilket är användbart för att hantera databasuppgraderingar genom migrations.
    ...
    @Volatile
    private var INSTANCE: MessageAppDatabase? = null

    fun getDatabase(context: Context): MessageAppDatabase { //DatabasInstansiering Forst kontrolelras om en instans av DB redan finns med getDatabase, om den finns returneras den befintliga instansen
